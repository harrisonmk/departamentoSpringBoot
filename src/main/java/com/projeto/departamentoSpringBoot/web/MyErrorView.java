package com.projeto.departamentoSpringBoot.web;
...
public class MyErrorView implements ErrorViewResolver {
    ...
    public ModelAndView resolveErrorView(HttpServletRequest request, HttpStatus status, Map<String, Object> map) {
        ...
        switch (status.value()) {
            ...
            case 404:
                model.addObject("error", "Página nao encontrada");
                model.addObject("message", "A url para a pagina '" + map.get("path") + "' nao existe ");
                break;
            case 500:
